...
const UploadStep = (props: {
  ...
  const urlPlaceholder = `http://example.com/path/to/${category === MetadataCategory.Image ? 'image' : 'file'
    }`;
      ...
      <Row className="content-action">
        ...
        >
          ...
          {coverArtError ? (
            ...
            <p className="ant-upload-text" style={{ color: '#b5b2b2' }}>
...
const Congrats = (props: {
  ...
  const newTweetURL = () => {
    const params = {
      text: "I've created a new NFT on Metaplex-V1, check it out!",
