...
export const AuctionCard = ({
  ...
  // EDIT: your token has 9 decimals you are good, otherwise you need to replace the number in Math.Ceil (100000000). For 9 decimals: 1000000000, for 7 decimals: 10000000, for 5 decimals: 100000, etc. 
  const LAMPORTS_PER_MINT = tokenInfo
    ? Math.ceil(1000000000)
    : LAMPORTS_PER_SOL;
  ...
  // EDIT: your token has 9 decimals you are good, otherwise you need to replace the number in tickSize.toNumber() / 1000000000;. For 9 decimals: 1000000000, for 7 decimals: 10000000, for 5 decimals: 100000, etc.
  ...
  const minBid =
    ...
    (isUpcoming || bids.length === 0
      ...
      : isStarted && bids.length > 0
        ...
        : 9999999) +
    tickSize.toNumber() / 1000000000;

    // EDIT: your token has 9 decimals you are good, otherwise you need to replace the number in value * 1000000000 < priceFloor. For 9 decimals: 1000000000, for 7 decimals: 10000000, for 5 decimals: 100000, etc.
    ...
    <div className="auction-container" style={style}>
          ...
          {showPlaceBid ? (
            <div className="show-place-bid">
              <AmountLabel
                ...
                displaySymbol={tokenInfo?.symbol || 'CustomToken'}
      ...
      <MetaplexOverlay visible={showRedeemedBidModal}>
        ...
        >
          ...
          redeemed, you can now view your NFTs in your Solana wallet. 
          .
        </p>
        <Button
